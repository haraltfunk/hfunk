            ...
            <section class="card mb-6">
                <div class="card-body">
                    ...
                    @can('enrolled', $course)
                        ...
                        <a class="btn btn-danger btn-block" href="{{ route('courses.status', $course) }}">Continuar con el curso</a>

                    @else
                    
                        <form action="{{ route('courses.enrolled', $course) }}" method="post">
                            @csrf
                            <button class="btn btn-danger btn-block" type="submit">Tomar este curso</button>
                        </form>
                    ...
                    <article class="flex items-center mb-6">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="flex items-center mb-2">
                                <img class="h-12 w-12 object-cover rounded-full shadow-lg" src="{{ $similar->teacher->profile_photo_url }}" alt="{{ $similar->teacher->name }}">
