            ...
            <div class="card-body bg-gray-100 overflow-hidden rounded-md ">
                ...
                @if ($requirement->id == $item->id)
                    ...
                    <form wire:submit.prevent="update">
                        <input wire:model="requirement.name" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-outline focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" placeholder="Nombre de la meta">
    ...
    <div x-data="{open:false}">
        ...
        <article x-show="open" class="card bg-gray-100 border border-gray-300 rounded-md shadow-outline overflow-hidden">
            <div class="card-body bg-gray-100">
                ...
                <div class="mb-4">
                    <input wire:model="name" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-outline focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" placeholder="Escriba el requerimiento...">
                    @error('name')
