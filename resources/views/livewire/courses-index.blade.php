<div>
    ...
    <div class="bg-gray-200 py-4 mb-24">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex">
            ...
            <button class="focus:outline-none bg-white shadow-lg h-12 px-4 rounded-lg text-gray-700 mr-4" wire:click="resetFilters">
            ...
            <div class="relative" x-data = '{ open : false }'>
                <button class="px-4 text-gray-700 block h-12 rounded-lg overflow-hidden focus:outline-none bg-white shadow-lg" x-on:click="open = true">
                    <i class="fa fa-binoculars text-xs mr-2" aria-hidden="true"></i>
                    Niveles
                    <i class="fas fa-angle-down text-xs ml-2"></i>
                </button>
                <!-- Dropdown Body -->
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-y-8 gap-x-6">
        ...
        @foreach ($courses as $course)
            <x-course-card :course="$course"/> {{-- : para que reconosca el PHP --}}
        @endforeach
